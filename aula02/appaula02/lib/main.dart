...
class ResponsiveHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isMobile =
        screenWidth < 600; // se a largura da tela for menor que 600 é mobile
    final isTablet = screenWidth >= 600 &&
        screenWidth < 1024; // largura maior  que 600 e menor que 1024 tablet
              ...
              child: ListView(
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const TelaCalculadora(),
                        ),
                      );
                    },
                  ),
                  ListTile(
                    ...
                    subtitle: const Text('Segure para abrir'),
                    onLongPress: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
